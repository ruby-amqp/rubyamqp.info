...
This guide covers [Ruby amqp gem](https://github.com/ruby-amqp/amqp) 1.0.x.
...
gem "amqp", "~> 1.0.2" # optionally: :git => "git://github.com/ruby-amqp/amqp.git", :branch => "1.0.x-stable"
```
