...
h2. Exchanges in AMQP 0.9.1 - overview
...
Now that message attributes and publishing have been introduced, it is time to take a look at one more core exchange type in AMQP 0.9.1. It is called {% yard_link headers %} exchange type and is quite powerful.
...
Matching on hashes (in AMQP 0.9.1 parlance - _attribute tables_) is also supported:
...
h2. Using the Publisher Confirms extension to AMQP 0.9.1
