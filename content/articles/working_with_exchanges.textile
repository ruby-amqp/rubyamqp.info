...
<span class="help-block">(if the example above isn't displayed, see this "gist":https://gist.github.com/1020181)</span>
...
<span class="help-block">(if the example above isn't displayed, see this "gist":https://gist.github.com/1041787)</span>
...
<span class="help-block">(if the example above isn't displayed, see this "gist":https://gist.github.com/998691)</span>
...
<span class="help-block">(if the example above isn't displayed, see this "gist":https://gist.github.com/1041778)</span>
...
<span class="help-block">(if the example above isn't displayed, see this "gist":https://gist.github.com/1020308)</span>
...
exchange.publish(Message.new)</pre>

<span class="help-block">(if the example above isn't displayed, see this "gist":https://gist.github.com/1020336)</span>
...
<pre>exchange.publish("Hey, what a great view!",
                 ...
                 :routing_key => "amqpgem.key")</pre>

<span class="help-block">(if the example above isn't displayed, see this "gist":https://gist.github.com/1020424)</span>
